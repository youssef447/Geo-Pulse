...
/// Date: 29/9/2024
/// By: Nada Mohammed
/// Representation: This is the Tablet view of the check out dialog.
class TabletCheckOutDialog extends GetView<TrackingHomeController> {
  const TabletCheckOutDialog({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                if (Get.find<LocationController>()
                  ...
                  Text(
                    '${'Did you take your'.tr} ${DateTimeHelper.formatInt(Get.find<LocationController>().locationModels[0].allowPeriodTimeNumber!)} ${Get.find<LocationController>().locationModels[0].allowPeriodTime?.getName == 'hrs' ? Get.locale.toString().contains('ar') ? 'ساعة' : 'Hour' : Get.locale.toString().contains('ar') ? 'دقيقة' : 'Minute'} ${'break?'.tr}',
